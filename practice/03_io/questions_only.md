 ...
 **TDD Phase:** Write minimal code to compile
 ...
 **TDD Phase:** Write minimal code to compile and run
 ...
 **TDD Phase:** Refactor (tests must stay green)
 ...
 **TDD Phase:** Write a test that exposes a bug
...
## x Exercise 10: Implement GetPlayerScore
...
**File:** `file_system_store.go`
 **TDD Phase:** Change interface to prepare for next feature
...
**File:** `file_system_store_test.go`
 **TDD Phase:** Update test infrastructure
 **Expected Result:** Tests pass ✓
...
**File:** `server.go`
 **TDD Phase:** Update interface
 **Expected Result:** Compilation errors (easy fixes)
 ...
 **TDD Phase:** Ship it!
 **Expected Result:** Application compiles and runs
...
**File:** `file_system_store.go`
 **TDD Phase:** Refactor for performance
 **Expected Result:** Tests pass ✓
 ...
 **TDD Phase:** Prepare for refactor
 ...
 **TDD Phase:** Write test exposing a bug
...
**Files:** `file_system_store_test.go`, `server_integration_test.go`, `main.go`
 **TDD Phase:** Fix compilation, add error handling
